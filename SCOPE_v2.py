...
def get_sun(sun_time, sun_frame, angle, reverse=False):
    ...
    while coord.get_sun(sun_time).transform_to(sun_frame).alt.value > angle:
        ...
        i += 1
        if i > 60*24:
            print("\033[93m"+"Warning: Sun did not reached the expected angle!"+"\033[0m")
...
print("\033[36m"+"Please select a location:"+"\033[0m")
for i in range(len(available_obs)):
    print("\033[94m"+"\t{}. ".format(i+1)+"\033[0m"+available_obs[i]+".")
selection = int(input("\033[32m"+"Choice: "+"\033[0m"))-1
if selection >= len(available_obs):
    selection = len(available_obs)-1
    print("\033[93m"+"Warning: Location unavailable, selected the last one instead."+"\033[0m")
...
# Date and time
obs_date = input("\033[32m"+"Date of observation [YYYY-MM-DD]: "+"\033[0m")
...
print("\033[36m"+"Night time [UTC]:"+"\033[0m")
print("\033[36m"+"\t    === Evening ===    "+"\033[0m")
print("\033[36m"+"\t               sunset: "+"\033[0m"+sun_set.to_string())
print("\033[36m"+"\t       civil twilight: "+"\033[0m"+sun_civil.to_string())
print("\033[36m"+"\t    nautical twilight: "+"\033[0m"+sun_nautical.to_string())
print("\033[36m"+"\tastronomical twilight: "+"\033[0m"+sun_astronomical.to_string())
print("\033[36m"+"\t    === Morning ===    "+"\033[0m")
print("\033[36m"+"\tastronomical twilight: "+"\033[0m"+sun_rastronomical.to_string())
print("\033[36m"+"\t    nautical twilight: "+"\033[0m"+sun_rnautical.to_string())
print("\033[36m"+"\t       civil twilight: "+"\033[0m"+sun_rcivil.to_string())
print("\033[36m"+"\t              sunrise: "+"\033[0m"+sun_rise.to_string())


obs_begin = input("\033[32m"+"Begin time of observation [hh:mm format; UTC]: "+"\033[0m")
obs_end =   input("\033[32m"+"  End time of observation [hh:mm format; UTC]: "+"\033[0m")
...
print("\033[36m"+"Observation constraints"+"\033[0m")
...
obs_sky_rotation = coord.Angle("{} hours".format(obs_duration.to_value("h"))) * (1*u.sday/u.day).decompose()
...
print("\033[36m"+"\tbegin date and time: "+"\033[0m" + obs_begin_time.to_string())
print("\033[36m"+"\t  end date and time: "+"\033[0m" + obs_end_time.to_string())
print("\033[36m"+"\tbegin sidereal time: "+"\033[0m" + st.to_string(unit=u.hour))
print("\033[36m"+"\t  end sidereal time: "+"\033[0m" + (st+obs_sky_rotation).to_string(unit=u.hour))
print("\033[36m"+"\t       sky rotation: "+"\033[0m" + obs_sky_rotation.to_string(unit=u.hour))
print("\033[36m"+"Sky coordinates window"+"\033[0m")
...
print("\033[36m"+"Simbad query constraints:"+"\033[0m")
